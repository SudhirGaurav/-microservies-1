...
@FeignClient(name = "currency-exchange") // upper one s comment because of hardcodef port , now feign will talk to Eureka and talk to registered "currency-exchange" services
